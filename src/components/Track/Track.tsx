  ...
  return (
    <div className={classes.Track} onContextMenu={contextMenuOpen}>
      ...
      <div className={classes.Content}>
        ...
        <div className={classes.album}><span>{playlist}</span></div>
