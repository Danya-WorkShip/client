...
import classes from './FollowingUserItem.module.scss';
import { IUser } from './../../../../../types/types';

interface IFollowingUserItem {
  user: IUser
}

const FollowingUserItem: FC<IFollowingUserItem> = ({user}) => {
  return (
    <div className={classes.followingUserItem}>
      <div className={classes.avatar}>
        <img src={user.avatar} alt='qwe'/>
      </div>
      <div className={classes.names}>
        <div className={classes.username}>{user.name}</div>
        <div className={classes.userId}>#{user.id_name}</div>
      </div>
