        ...
        <div className={classes.FeedPost}>
            ...
            >
                <ContextMenu x={contextMenu.x} y={contextMenu.y} closeContextMenu={contextMenuClose}>
                    <ul className={classes.ContextButtons} id='ContextButtons' onClick={e => e.stopPropagation()}>
                        {!isUserOwnerProfile
                            ?
                            <>
                ...
                <div className={classes.Background} style={post.image_id !== 0 ? {background: `url(${user.avatar})`} : {}}>
                    <div className={classes.Post} style={post.image_id !== 0 ? {background: 'rgba(0, 0, 0, 0.3)'} : {}}>
                        ...
                        <div className={classes.AdditionalContent}>
                            {post.image_id !== 0 && <img onClick={() => setPhotoPopupOpen(true)} src={user.avatar} alt=''/>} {/* TODO: Изменить на поиск картинок с индексом поста*/}
                        </div>
                        ...
                        <div className={classes.Actions}>
                            ...
                            <div className={classes.Action} onClick={() => setOpenCommentSection(!openCommentSection)} style={openCommentSection ? {background: '#313131'} : {}}>
            ...
            <CSSTransition
                ...
                unmountOnExit 
                timeout={300}
                classNames="photoPopup"
            >
                <PopUp active={photoPopupOpen} setOpen={setPhotoPopupOpen}>
                    <div className={classes.PhotoPopup}>
                        <div className={classes.Content}>
                            <div className={classes.Photo}><img src={user.avatar} alt="" /></div>
                            <div className={classes.Description}>qweqwrwqrqw</div>
