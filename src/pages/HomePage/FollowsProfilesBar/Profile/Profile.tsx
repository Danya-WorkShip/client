...
const Profile: FC<IProfile> = ({user}) => {
    ...
    return (
        <div className={classes.Profile} onClick={() => setOpen(!open)} onContextMenu={(e) => {e.preventDefault(); setOpen(true)}} ref={ContextMenuRef}>
            <CSSTransition
                in={open}
                unmountOnExit 
                timeout={300}
                classNames="profileHover"
            >
                <div className={classes.ProfileHover}>
                    <div className={classes.Trigger}>
                        <div className={classes.Info}>
                            <div className={classes.InfoAvatar}><img src={user.avatar} alt="" /></div>
                            <div className={classes.Names}>
                                <div className={classes.Name}>{getTruncatedName(user.name, 15)}</div>
