...
import classes from './SearcherLeftProfile.module.scss';
import { CSSTransition } from 'react-transition-group';
import ContextMenu from '../../../../components/ContextMenu/ContextMenu';

interface ISearcherLeftProfile {
    user: IUser
}

const SearcherLeftProfile: FC<ISearcherLeftProfile> = ({user}) => {
    ...
    return (
        <div className={classes.SearcherLeftProfile} onContextMenu={contextMenuOpen}>
            <CSSTransition
                in={contextMenu.show}
                unmountOnExit 
                timeout={300}
