...
import classes from './FriendsProfile.module.scss';
import { IUser } from './../../../../types/types';
import ContextMenu from './../../../../components/ContextMenu/ContextMenu';
import { CSSTransition } from 'react-transition-group';

interface IFriendsProfile {
    user: IUser
}

const FriendsProfile: FC<IFriendsProfile> = ({user}) => {
    ...
    const contextMenuOpen = (e: React.MouseEvent<HTMLDivElement, globalThis.MouseEvent>) => {
        ...
        setContextMenu({show: !contextMenu.show, x: clientX, y: clientY})
    }
    ...
    return (
        <div className={classes.Profile} onContextMenu={contextMenuOpen}>
            <CSSTransition
                in={contextMenu.show}
                unmountOnExit 
                timeout={300}
